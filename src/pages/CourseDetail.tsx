...
import { ArrowLeft, BookOpen, Clock, Users, Star, Play, FileText, Image as ImageIcon, HelpCircle, CheckCircle2, Circle } from "lucide-react";
        ...
        >
          ...
          <div className="bg-card rounded-xl border border-border p-6 shadow-card space-y-5 h-fit">
            ...
            <Link to={`/lesson/${course.id}`}>
              <Button className="w-full bg-gradient-hero text-primary-foreground font-bold text-base hover:opacity-90" size="lg">
